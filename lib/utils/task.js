...
const taskHelper = {
  ...
  isSentToApplicant: task => {
    return task.status === 'sent-to-applicant';
  },

  isAcceptedConditions: task => {
    return task.status === 'conditions-accepted';
  },

  isRepresentationsMade: task => {
    return task.status === 'representation-made';
  }
};
