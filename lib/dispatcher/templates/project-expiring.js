...
1. Submit a list of any publications your work has been published in by {{publicationsDate}}. This should be emailed to asrulicensing@homeoffice.gov.uk.
...
module.exports = {
  requires: ['months', 'licenceNumber', 'expiryDate', 'ropsDate', 'publicationsDate', 'licenceUrl', 'loginUrl'],
  value
};
